export const dom = {
  ...
  libraryFilterTrigger: document.querySelector("#library-filter-trigger"),
  libraryFilterBadge: document.querySelector("#library-filter-badge"),
  libraryActiveFilters: document.querySelector("#library-active-filters"),
  libraryFilterDialog: document.querySelector("#library-filter-dialog"),
  filterDialogClose: document.querySelector("#filter-dialog-close"),
  filterDialogSearch: document.querySelector("#filter-dialog-search"),
  filterDialogTags: document.querySelector("#filter-dialog-tags"),
  filterDialogProjects: document.querySelector("#filter-dialog-projects"),
  filterDialogTagsSection: document.querySelector(
    "#filter-dialog-tags-section",
  ),
  filterDialogProjectsSection: document.querySelector(
    "#filter-dialog-projects-section",
  ),
  filterDialogClear: document.querySelector("#filter-dialog-clear"),
  filterDialogApply: document.querySelector("#filter-dialog-apply"),
  readerBackButton: document.querySelector("#reader-back-button"),
  readerFocusButton: document.querySelector("#reader-focus-button"),
  ...
  openAddProjectModalButton: document.querySelector("#open-add-project-modal"),
  ...
  autoTagRuleDetails: document.querySelector("#auto-tag-rule-details"),
